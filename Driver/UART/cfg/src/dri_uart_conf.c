...
tStUART_Configuartion UART_Channel_0_Configuration =
{
	...
	.isr_config =
	{
		...
		.event_irq = { .irq_num = USIC0_0_IRQn, .irq_priority = 58 },
	#endif
	#ifdef UART_TX_INTERRUPT_USED
		.tx_irq = { .irq_num = USIC0_2_IRQn, .irq_priority = 60 },
	#endif
	#ifdef UART_RX_INTERRUPT_USED
		.rx_irq = { .irq_num = USIC0_1_IRQn, .irq_priority = 59 }
	#endif
	},
	#endif
	.fifo_cfg =
...
tStUART_Configuartion UART_Channel_2_Configuration =
{
	...
	.isr_config =
	{
		...
		.event_irq = { .irq_num = USIC1_0_IRQn, .irq_priority = 58 },
	#endif
	#ifdef UART_TX_INTERRUPT_USED
		.tx_irq = { .irq_num = USIC1_2_IRQn, .irq_priority = 60 },
	#endif
	#ifdef UART_RX_INTERRUPT_USED
		.rx_irq = { .irq_num = USIC1_1_IRQn, .irq_priority = 59 }
	#endif
	},
	#endif
	.fifo_cfg =
...
/******* ISR Handlers for UART channel 4 *******/

#ifdef UART_4_TX_HANDLER
/**
 * @function	UART_4_TX_HANDLER
 *
 ...
 *
 */
void UART_4_TX_HANDLER( void )
{
	/* Call ISR entry function */
	UART_isr_entry( &UART_Channel_4, UART_INTERRUPT_OPERATION_TX );
}
#endif	/* UART_4_TX_HANDLER */


#ifdef UART_4_RX_HANDLER
/**
 * @function	UART_4_RX_HANDLER
 *
 ...
 *
 */
void UART_4_RX_HANDLER( void )
{
	/* Call ISR entry function */
	UART_isr_entry( &UART_Channel_4, UART_INTERRUPT_OPERATION_RX );
}
#endif	/* UART_4_RX_HANDLER */


#ifdef UART_4_ERR_HANDLER
/**
 * @function	UART_4_ERR_HANDLER
 *
 ...
 *
 */
void UART_4_ERR_HANDLER( void )
{
	/* Call ISR entry function */
	UART_isr_entry( &UART_Channel_4, UART_INTERRUPT_OPERATION_ERROR );
}

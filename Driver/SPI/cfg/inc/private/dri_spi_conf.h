...
#define SPI_INTERNAL_SLAVE_SELECT_USED	0U
...
#define SPI0_CHANNEL0_TX_SR				0
#define SPI0_CHANNEL0_RX_SR				1
#define SPI0_Channel0_Transmit_Handler	IRQ_Hdlr_84
#define SPI0_Channel0_Receive_Handler	IRQ_Hdlr_85

#if (SPI_PROTOCOL_EVENTS_USED == 1U)
#define SPI0_CHANNEL0_EVENT_SR			2
#define SPI0_Channel0_Protocol_Handler	IRQ_Hdlr_86

...
typedef struct tStSPI_StatusControl_
{
	union
	{
		struct
		{
			...
			volatile unsigned long slave	: 24;/* SS functionality */
			volatile unsigned long tx_dummy	: 1;
			volatile unsigned long rx_dummy	: 1;
			volatile unsigned long size		: 1;/* Size of data, sued for 8/16 bits transfer */
...
typedef struct tStSPI_Control_
{
	...
	tStSPI_MasterStatusControl state;

...
public:
	...
	explicit ClientTask__( const UBaseType_t& uxPriority, const configSTACK_DEPTH_TYPE& usStackDepth )
	{
	...
	ClientTask__( const ClientTask__& ) = delete;
	ClientTask__ operator=( const ClientTask__& ) = delete;

...
/* Gloabl constructor for External Flash Module over SPI0 Channel 0 */
ExternalFlash__ ext_flash( &SPI0_Channel0_Handle, &SPI0_Channel0_API );
...
long ExternalFlash__::init( const unsigned char& initialize )
{
	...
	{
		/* Initialzie interface channel if not yet [in init function not in constructor] */
